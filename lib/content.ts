...
export const valueCards: { title: ContentByLang; desc: ContentByLang }[] = [
  ...
  },
  {
    ...
    desc: {
      en: "200+ SKUs across 6 categories. Broaden your catalog with spinning, casting, surf, telescopic, ice, and travel rods.",
      es: "200+ SKU en 6 categorías. Spinning, casting, surf, telescópica, hielo y viaje.",
      fr: "200+ SKU dans 6 catégories. Spinning, casting, surf, télescopique, glace et voyage.",
      de: "200+ SKUs in 6 Kategorien. Spinning, Casting, Surf, Teleskop, Eis und Reise.",
      ar: "200+ وحدة في 6 فئات. سبينينغ، كاستينغ، سيرف، تلسكوبية، جليد وسفر.",
      ru: "200+ SKU в 6 категориях. Спиннинг, кастинг, серф, телескоп, лед, путешествия.",
      ja: "6カテゴリー200+SKU。スピニング、キャスティング、サーフ、テレスコピック、アイス、トラベル。",
      ko: "6개 카테고리 200+ SKU. 스피닝, 캐스팅, 서프, 텔레스코픽, 아이스, 트래블.",
      pt: "200+ SKUs em 6 categorias. Spinning, casting, surf, telescópica, gelo e viagem.",
    },
  },
  {
    title: {
...
export const companyIntro: Record<LangCode, { title: string; desc: string; aboutLink: string; stats: { title: string; subtitle: string }[] }> = {
  en: {
    ...
    aboutLink: "About Us →",
    stats: [
      { title: "200+ SKUs", subtitle: "Across 6 Categories" },
  ...
  es: {
    ...
    stats: [
      { title: "200+ SKU", subtitle: "En 6 categorías" },
  ...
  fr: {
    ...
    aboutLink: "À propos →",
    stats: [
      { title: "200+ SKU", subtitle: "Dans 6 catégories" },
  ...
  de: {
    ...
    aboutLink: "Über uns →",
    stats: [
      { title: "200+ SKUs", subtitle: "In 6 Kategorien" },
  ...
  ar: {
    ...
    aboutLink: "من نحن →",
    stats: [
      { title: "200+ وحدة", subtitle: "في 6 فئات" },
  ...
  ru: {
    ...
    aboutLink: "О нас →",
    stats: [
      { title: "200+ SKU", subtitle: "В 6 категориях" },
  ...
  ko: {
    ...
    aboutLink: "회사 소개 →",
    stats: [
      { title: "200+ SKU", subtitle: "6개 카테고리" },
  ...
  pt: {
    ...
    aboutLink: "Sobre nós →",
    stats: [
      { title: "200+ SKUs", subtitle: "Em 6 categorias" },
...
> = {
  en: {
    ...
    successDesc: "We will reply within 24 hours.",
  ...
  es: {
    ...
    successDesc: "Responderemos en 24 horas.",
  ...
  fr: {
    ...
    successDesc: "Nous répondrons sous 24 heures.",
  ...
  de: {
    ...
    successDesc: "Wir werden innerhalb von 24 Stunden antworten.",
