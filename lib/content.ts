...
> = {
  en: {
    ...
    regions: ["USA", "EU", "Middle East", "Southeast Asia", "Russia & Central Asia"],
  ...
  es: {
    ...
    regions: ["USA", "UE", "Oriente Medio", "Sudeste Asiático", "Rusia y Asia Central"],
  ...
  fr: {
    ...
    regions: ["USA", "UE", "Moyen-Orient", "Asie du Sud-Est", "Russie & Asie centrale"],
  ...
  de: {
    ...
    regions: ["USA", "EU", "Naher Osten", "Südostasien", "Russland & Zentralasien"],
  ...
  ar: {
    ...
    regions: ["الولايات المتحدة", "الاتحاد الأوروبي", "الشرق الأوسط", "جنوب شرق آسيا", "روسيا وآسيا الوسطى"],
  ...
  ru: {
    ...
    regions: ["США", "ЕС", "Ближний Восток", "Юго-Восточная Азия", "Россия и Центральная Азия"],
  ...
  ja: {
    ...
    regions: ["米国", "EU", "中東", "東南アジア", "ロシア・中央アジア"],
    block2Title: "精密製造",
  ...
  ko: {
    ...
    regions: ["미국", "EU", "중동", "동남아시아", "러시아·중앙아시아"],
    block2Title: "정밀 제조",
  ...
  pt: {
    ...
    regions: ["EUA", "UE", "Oriente Médio", "Sudeste Asiático", "Rússia e Ásia Central"],
