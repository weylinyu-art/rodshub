...
export const T: Translations = {
  ...
  shareRecommendedCopy: { en: "I found a professional B2B fishing rod marketplace – 2000+ SKUs, 24h reply, OEM available. Tackle businesses, don't miss this! 👉", es: "Encontré un marketplace B2B de cañas de pesca – 2000+ SKUs, respuesta en 24h, OEM. ¡No te lo pierdas! 👉", fr: "J'ai trouvé un marketplace B2B de cannes à pêche – 2000+ SKU, réponse 24h, OEM. À ne pas manquer ! 👉", de: "Ich habe einen professionellen B2B-Marktplatz für Angelruten gefunden – 2000+ Artikel, 24h Antwort, OEM. Nicht verpassen! 👉", ar: "وجدت سوق B2B احترافي لقضبان الصيد – 2000+ وحدة، رد خلال 24 ساعة، OEM. لا تفوت الفرصة! 👉", ru: "Нашёл профессиональный B2B-маркетплейс удилищ – 2000+ SKU, ответ за 24ч, OEM. Не пропустите! 👉", ja: "プロのB2B釣り竿マーケットを見つけました – 2000+SKU、24時間返信、OEM対応。必見です！👉", ko: "전문 B2B 낚싯대 마켓플레이스를 찾았어요 – 2000+ SKU, 24시간 답변, OEM 가능. 꼭 확인해보세요! 👉", pt: "Encontrei um marketplace B2B de varas de pesca – 2000+ SKUs, resposta em 24h, OEM. Não perca! 👉" },
