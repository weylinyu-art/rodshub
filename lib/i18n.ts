...
export const T: Translations = {
  ...
  shareRecommendedCopy: { en: "I found a professional B2B fishing rod marketplace – 200+ SKUs, wholesale $8-18, 24h reply, OEM available. Tackle businesses, don't miss this! 👉", es: "Encontré un marketplace B2B de cañas de pesca – 200+ SKUs, mayorista $8-18, respuesta 24h, OEM. ¡No te lo pierdas! 👉", fr: "J'ai trouvé un marketplace B2B de cannes à pêche – 200+ SKU, gros $8-18, réponse 24h, OEM. À ne pas manquer ! 👉", de: "Ich habe einen professionellen B2B-Marktplatz für Angelruten gefunden – 200+ Artikel, Großhandel $8-18, 24h Antwort, OEM. Nicht verpassen! 👉", ar: "وجدت سوق B2B احترافي لقضبان الصيد – 200+ وحدة، جملة $8-18، رد خلال 24 ساعة، OEM. لا تفوت الفرصة! 👉", ru: "Нашёл профессиональный B2B-маркетплейс удилищ – 200+ SKU, оптом $8-18, ответ за 24ч, OEM. Не пропустите! 👉", ja: "プロのB2B釣り竿マーケットを見つけました – 200+SKU、卸売$8-18、24時間返信、OEM対応。必見です！👉", ko: "전문 B2B 낚싯대 마켓플레이스를 찾았어요 – 200+ SKU, 도매 $8-18, 24시간 답변, OEM 가능. 꼭 확인해보세요! 👉", pt: "Encontrei um marketplace B2B de varas de pesca – 200+ SKUs, atacado $8-18, resposta 24h, OEM. Não perca! 👉" },
